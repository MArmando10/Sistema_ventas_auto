...
<div class="card">
  ...
  <div class="card-body">
      <form class="CLIENTE" method="POST" action="{{route('cliente.store')}}">
 ...
 {{$errors}}
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <input type="text" id="txtNombreC" class="form-control" value="{{old('NombreC')}}" name="NombreC" placeholder="Ingresa Nombre"  required   onKeyPress="return soloLetras(event)" onkeyup="soloLetras(this);">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" id="txtDomi" class="form-control" value="{{old('Domi')}}" name="Domi" placeholder="Ingresa el Domicilio"  required  onKeyPress="return soloLetras(event)" onkeyup="soloLetras(this);">
                        <p class="inputError">{{ $errors->first('Domi') }}</p>
                    </div>

                     <div class="form-group col-md-3">
                        <label for="txtMunicipio">Municipio</label>
                        <input type="text" id="txtMunicipio" class="form-control" value="{{old('Municipio')}}" name="Municipio" placeholder="Ingresa el Municipio"  required  onKeyPress="return soloLetras(event)" onkeyup="soloLetras(this);">
                        <p class="inputError">{{ $errors->first('Municipio') }}</p>
                    </div>

                     <div class="form-group col-md-3">
                        <label for="txtEsttado">Estado</label>
                        <input type="text" id="txtEsttado" class="form-control" value="{{old('Estado')}}" name="Estado" placeholder="Ingresa el Estado"  required  onKeyPress="return soloLetras(event)" onkeyup="soloLetras(this);">
                        <p class="inputError">{{ $errors->first('Estado') }}</p>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="txtTelefono">Telefono</label>
                        <input type="text" id="txtTelefono" class="form-control" value="{{old('Telefono')}}" name="Telefono" placeholder="Ingresa el Telefono" required onKeyPress="return soloNumeros(event)" onkeyup="soloNumeros(this);">
