...
<div class="card">
  ...
  <div class="card-body">
      <form class="Vendedor" method="POST" action="{{route('vendedor.store')}}">
 ...
 {{$errors}}
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" id="txtCodigo" class="form-control" value="{{old('Codigo')}}" name="Codigo" placeholder="Ingresa la Matricula"  required   onKeyPress="return soloNumeros(event)" onkeyup="soloNumeros(this);">
                    ...
                    <div class="form-group col-md-4">
                            ...
                            <select class="form-control form-control-chosen-required {{$errors->first('Puesto') ? 'has-error' : ''}}" id="txtPuesto" placeholder="Ingrese el puesto" name="Puesto" required >
                             @if(!old('Puesto') || old('Puesto') == 'Elige...')  <option selected>Elige...</option> @endif
                              ...
                              <option value="0" {{old('Puesto') == '0' ? 'selected' : ''}}>Jefe</option>
                                <option value="1" {{old('Puesto') == '1' ? 'selected' : ''}}>Promotor</option>
                            </select>
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" id="txtNombreV" class="form-control" value="{{old('NombreV')}}" name="NombreV" placeholder="Ingresa Nombre"  required   onKeyPress="return soloLetras(event)" onkeyup="soloLetras(this);">
                        <p class="inputError">{{ $errors->first('NombreV') }}</p>
                    </div>       

                    <div class="form-group col-md-4">
                        <label for="txtApellidoPV">Primer Apellido</label>
                        <input type="text" id="txtApellidoPV" class="form-control" value="{{old('ApellidoPV')}}" name="ApellidoPV" placeholder="Ingresa el primer apellido"  required   onKeyPress="return soloLetras(event)" onkeyup="soloLetras(this);">
                        <p class="inputError">{{ $errors->first('ApellidoPV') }}</p>
                    </div>
                  
                      <div class="form-group col-md-4">
                        <label for="txtApellidoMV">Segundo Apellido</label>
                        <input type="text" id="txtApellidoMV" class="form-control" value="{{old('ApellidoMV')}}" name="ApellidoMV" placeholder="Ingresa el segundo apellido"  required   onKeyPress="return soloLetras(event)" onkeyup="soloLetras(this);">
